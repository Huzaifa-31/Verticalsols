      ...
      <div className="row justify-content-xl-between justify-content-center">
        <div className="col-xl-4 col-lg-5 col-md-6">
          <div className="footer-widget widget_about me-md-5 wow fadeInUp delay-0-2s">
            ...
            <p>
              At VerticalSols, we are passionate about harnessing the power of
              technology to help businesses thrive. Our team of experts has
              years of experience in creating innovative solutions for
              businesses of all sizes, from startups to established
              corporations. We believe that technology should be used to
              simplify and streamline business operations, and our services are
    ...
    <div className="footer-bottom mt-30 pt-25 pb-10">
      <div className="container">
        <div className="copyright-text text-center">
          <p>© Copyright 2023 Verticalsols. All right reserved</p>
        </div>
      </div>
    </div>
  </footer>
