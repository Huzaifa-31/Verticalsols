...
const ServicesDetails = () => {
  ...
  const _isServices = useSelector((state) => state.isService);
  console.log("isservice", _isServices);

  return (
    <Layout>
      <PageBanner
        titleHtml={_isServices==="Mean"?`Mean/Mern &amp; Develop<span>ment</span>`:_isServices==="Laravel"?`Laravel &amp; Develop<span>ment</span>`:''}
        titleText={_isServices==="Mean"?"Mean/Mern Development":"Web Development"}
      />
