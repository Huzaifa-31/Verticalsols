...
const SocialMedia = () => {
  ...
  return (
    <Layout>
      <PageBanner
        titleHtml={` Social Media Marketing  <span>SERVICES</span>`}
          ...
          <div className="row row-cols-xl-5 row-cols-md-3 row-cols-sm-2 row-cols-1 justify-content-center">
            <div className="col">
              <div className="feature-item-seven mt-30 wow fadeInUp delay-0-2s">
                ...
                <h5>Set specific and measurable goals</h5>
                <p>Define your objectives and ensure they can be quantified.</p>
              </div>
            </div>
            <div className="col">
              <div className="feature-item-seven color-two wow fadeInUp delay-0-2s">
                ...
                <h5>Identify your target audience</h5>
                <p>Understand their interests, behaviors, and preferences.</p>
              </div>
            </div>
            <div className="col">
              <div className="feature-item-seven color-three mt-40 wow fadeInUp delay-0-2s">
                ...
                <h5>Develop a content strategy</h5>
                <p>Create content aligned with goals and audience.</p>
              </div>
            </div>
            <div className="col">
              <div className="feature-item-seven color-four wow fadeInUp delay-0-2s">
                ...
                <h5>Engage with your followers</h5>
                <p>Respond to comments, messages, and create conversations.</p>
              </div>
            </div>
            <div className="col">
              <div className="feature-item-seven color-five mt-40 wow fadeInUp delay-0-2s">
                ...
                <h5>Monitor and analyze your results</h5>
                <p>Track metrics and adjust strategy as needed.</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="col-xl-12 col-lg-12">
                <div className="pricing-plan-content text-center mb-65 wow fadeInUp delay-0-2s">
                  <div className="section-title text-center mb-30">
                    ...
                    <h3>
                      Choose Your Best Pricing Plan for Social Media Marketing
                      SERVICES
                    </h3>
                  </div>
                  ...
                  <div className="col-xl-4 col-md-6">
                    <div className="pricing-plan-three style-two">
                      ...
                      <ul className="list-style-two">
                        ...
                        <li> Number of platforms(1) </li>
                        <li> Management duration days(30) </li>
                      </ul>
