...
const Seo = () => {
  ...
  return (
    <Layout>
      <PageBanner
        titleHtml={` Search Engine Optimization  <span>SERVICES</span>`}
          ...
          <div className="row row-cols-xl-5 row-cols-md-3 row-cols-sm-2 row-cols-1 justify-content-center">
            <div className="col">
              <div className="feature-item-seven mt-30 wow fadeInUp delay-0-2s">
                ...
                <p>
                  Identify the most relevant and high-traffic keywords related
            ...
            <div className="col">
              <div className="feature-item-seven color-two wow fadeInUp delay-0-2s">
                ...
                <p>
                  Optimize your website's content, meta tags, headings, images,
                  and internal links for the targeted keywords.
                </p>
              </div>
            </div>
            <div className="col">
              <div className="feature-item-seven color-three mt-40 wow fadeInUp delay-0-2s">
                ...
                <p>
                  Ensure that your website is technically optimized for search
                  engines, including site speed, mobile-friendliness, SSL
                  certificate, robots.txt, sitemaps, and structured data.
                </p>
              </div>
            </div>
            <div className="col">
              <div className="feature-item-seven color-four wow fadeInUp delay-0-2s">
                ...
                <p>
                  ...
                  through content marketing, guest blogging, social media,
                  influencer outreach, and other link-building tactics
                </p>
              </div>
            </div>
            <div className="col">
              <div className="feature-item-seven color-five mt-40 wow fadeInUp delay-0-2s">
                ...
                <h5>Local SEO</h5>
                <p>
                  Optimize your website and Google My Business listing for local
                  search queries and local intent.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="col-xl-12 col-lg-12">
                <div className="pricing-plan-content text-center mb-65 wow fadeInUp delay-0-2s">
                  <div className="section-title text-center mb-30">
                    ...
                    <h3>
                      Choose Your Best Pricing Plan for Search Engine
                ...
                <div className="row justify-content-center">
                  <div className="col-xl-4 col-md-6">
                    <div className="pricing-plan-three style-two">
                      ...
                      <ul className="list-style-two">
                        <li> 5 Optimize Articles 1200 words</li>
                        <li> Atleast DA 20</li>
                        <li> Unique + Safe</li>
                  ...
                  <div className="col-xl-4 col-md-6">
                    <div className="pricing-plan-three style-two">
                      ...
                      <h4>Standard</h4>
                      <ul className="list-style-two">
                        <li> 10 Optimize Articles 1200 words</li>
                        <li> Atleast DA 20</li>
                        <li> Unique + Safe</li>
                        <li> Backlink analysis </li>
                        <li> Competitor backlink analysis </li>
                  ...
                  <div className="col-xl-4 col-md-6">
                    <div className="pricing-plan-three style-two">
                      ...
                      <h4>Premium</h4>
                      <ul className="list-style-two">
                        <li> 20 Optimize Articles 1200 words</li>
                        <li> Atleast DA 20</li>
                        <li> Unique + Safe</li>
                        <li> Backlink analysis </li>
                        <li> Competitor backlink analysis </li>
