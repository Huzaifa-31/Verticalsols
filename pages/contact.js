              ...
              <div className="contact-info wow fadeInLeft delay-0-2s">
                <div className="contact-info-item style-two">
                  ...
                  <div className="content">
                    ...
                    <span className="text">
                      Plot No: 313, F, Block, Shah Rukn E Alam St, F Block Block
                      F Shah Rukn E Alam Housing Scheme, Multan, Punjab,
                      Pakistan
                    </span>
                  </div>
                </div>
                ...
                <div className="contact-info-item style-two">
                  ...
                  <div className="content">
                    ...
                    <span className="text">
                      Call <a href="calto:+92612118776">+92 61 2118776</a>
                      <br />
                      Whatsapp : +923436065860
                    </span>
                  </div>
                </div>
              ...
              <div className="location-address-item wow fadeInUp delay-0-2s">
                ...
                <div className="bottom-part">
                  <ul>
                    ...
                    <li>
                      <i className="far fa-phone" /> +92612118776
                    </li>
                  </ul>
                </div>
              </div>
