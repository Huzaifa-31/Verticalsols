...
const Laravel = () => {
  ...
  return (
    <Layout>
      <PageBanner
        titleHtml={` Laravel/ PHP Development   <span>SERVICES</span>`}
          ...
          <div className="row justify-content-between">
            <div className="col-xl-6 col-lg-6">
              <div className="what-we-offer-left mb-30 rmb-65 wow fadeInRight delay-0-2s">
                <div className="section-title mb-25">
                  ...
                  <h2>Full-Stack Web Development with Laravel and PHP</h2>
                </div>
                <h5>
            ...
            <div className="col-xl-6 col-lg-6">
              <div className="what-we-offer-right wow fadeInLeft delay-0-2s">
                <p>
                  <b>
                    Laravel is an open-source PHP web application framework that
                    follows the Model-View-Controller (MVC) architectural
                    pattern. It provides a wide range of features and tools that
                    help in developing modern, dynamic, and scalable web
                    applications. Some of the key features of Laravel include
                    the Blade templating engine, Eloquent ORM, Artisan
                    command-line interface, authentication and authorization
                    system, security features, routing, middleware, queues, and
                    testing tools.
                  </b>
                </p>
                <ul className="list-style-four pt-5">
                  <li>
                    <b>
                      we used front-end technologies like HTML, CSS, and
                      JavaScript to build complete web applications along with
                      popular front-end frameworks like Vue.js, React, or
                      Angular, is used to create dynamic and interactive user
                      interfaces
                    </b>
                  </li>
                  <li>
                    <b>
                      Laravel also provides support for popular databases like
                      MySQL, PostgreSQL, SQLite, and SQL Server. Object
                      Relational Mapping (ORM) tool, Eloquent, provides a simple
                      and intuitive way to work with databases
                    </b>
                  </li>
                  <li>
                    <b>
              ...
              <div className="col-xl-12 col-lg-12">
                <div className="pricing-plan-content text-center mb-65 wow fadeInUp delay-0-2s">
                  <div className="section-title text-center mb-30">
                    ...
                    <h3>
                      Choose Your Best Pricing Plan for Laravel / PHP SERVICES
                    </h3>
                  </div>
