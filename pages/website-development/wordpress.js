...
const Wordpress = () => {
  ...
  return (
    <Layout>
      <PageBanner
        titleHtml={` WORDPRESS WEB DESIGN <span>SERVICES</span>`}
          ...
          <div className="row justify-content-between">
            <div className="col-xl-6 col-lg-6">
              <div className="what-we-offer-left mb-30 rmb-65 wow fadeInRight delay-0-2s">
                <div className="section-title mb-25">
                  ...
                  <h2>
                    Professional WordPress Development to Enhance Your Online
                    Presence
                  </h2>
                </div>
                <h5>
            ...
            <div className="col-xl-6 col-lg-6">
              <div className="what-we-offer-right wow fadeInLeft delay-0-2s">
                <p>
                  <b>
                    Our team of experts is dedicated to providing custom
                    WordPress solutions tailored to your specific needs and
                    goals. We offer a wide range of services including website
                    design and development, plugin and theme customization,
                    e-commerce integration, and more. Our goal is to deliver
                    high-quality results that exceed your expectations and help
                    you achieve success in your online endeavors.
                  </b>
                </p>
              ...
              <div className="col-xl-12 col-lg-12">
                <div className="pricing-plan-content text-center mb-65 wow fadeInUp delay-0-2s">
                  <div className="section-title text-center mb-30">
                    ...
                    <h3>Choose Your Best Pricing Plan for WordPres </h3>
                  </div>
